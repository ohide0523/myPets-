...
const login = () => {
  ...
  const { uid,email,setEmail,password,setPassword,newEmail,setNewEmail,newPassword,setNewPassword,emailLogin,createEmailUsergoogleLogin } = useContext(Context);
