...
const editItem = () => {
const [editItemImg,setEditItemImg] = use
  ...
  return (
    ...
    >
      ...
      <button onClick={edit_item}>編集を確定する</button>
      <button onClick={delete_item}>削除する</button>
    </div>
  );
};
