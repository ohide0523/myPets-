  ...
  return (
    <>
      ...
      <div className={Styles.input_form}>
        ...
        /> */}
          <TextField className={Styles.input} label="Standard" ref={ref} onKeyDown={(e) => submitMsg(e)} value={content}
          onChange={(e) => setContent(e.target.value)}/>
        ...
        <SendIcon  onClick={onClickSubmitMsg} className={Styles.input_button}/>
      </div>
    </>
  );
};
