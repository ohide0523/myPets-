...
const chat = () => {
  ...
  return (
    <>
      ...
      <div className={classes.imput_form}>
        {/* <input
          type="text"
          value={content}
        ...
        /> */}
          <TextField className={Styles.input} label="メッセージを入力" ref={ref} onKeyDown={(e) => submitMsg(e)} value={content}
          onChange={(e) => setContent(e.target.value)}/>



       
        <SendIcon  onClick={onClickSubmitMsg} fontSize='large' color= 'primary'/>
      </div>
    </>
  );
};
