  ...
  return (
    <>
            ...
            <div key={index}>
              ...
              >
                <div style={{display:"flex",flexDirection:"column"}}>
                  <div style={{alignSelf:"flex-end",marginRight:10,marginBottom:5}}>{msg.name}</div>
              ...
              <div
                className={
                  uid == msg.id ? Styles.says_time_r : Styles.says_time_
                }
              >
      ...
      <div className={classes.input_form}>
          ...
          <TextField className={classes.input} label="メッセージを入力" ref={ref} onKeyDown={(e) => submitMsg(e)} value={content}
          onChange={(e) => setContent(e.target.value)}/>



       
        <SendIcon  className={classes.button} onClick={onClickSubmitMsg} fontSize='large' color= 'primary'/>
      </div>
    </>
  );
};
