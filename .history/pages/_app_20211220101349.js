        ...
        {isSearch ? (
          <AppBar position="static">
            <Toolbar className={classes.toolbar_open}>
              ...
              <FormControl variant="outlineed" className={classes.select}>
                ...
                >
                  ...
                  <MenuItem value={10}>オーストラリアンシェパード</MenuItem>
                  <MenuItem value={20}>シーズー</MenuItem>
                  <MenuItem value={30}>柴犬</MenuItem>
                </Select>
              </FormControl>
          </AppBar>
        ) : (
