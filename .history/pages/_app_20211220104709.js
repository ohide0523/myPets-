        ...
        <DialogContent>
          <form className={classes.container}>
            <FormControl className={classes.formControl}>
              <InputLabel htmlFor="demo-dialog-native">カテゴリー</InputLabel>
              <Select
                native
                // value={age}
              ...
              >
                ...
                <option value={20}>柴犬</option>
                <option value={"オーストラリアンシェパーd"}}>オーストラリアンシェパード</option>
              </Select>
            </FormControl>
            <FormControl className={classes.formControl}>
              <InputLabel id="demo-dialog-select-label">表示の順番</InputLabel>
              <Select
              ...
              >
                ...
                <MenuItem value={"新しく追加された順"}>新しく追加された順</MenuItem>
              </Select>
            </FormControl>
          </form>
        </DialogContent>
