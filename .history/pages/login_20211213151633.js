...
const login = () => {
  ...
  const { uid,email,setEmail,password,setPassword,newEmail,setNewEmail,newPassword,setNewPassword,emailLogin,createEmailUser,googleLogin } = useContext(Context);
  ...
  return (
    <div>
      ...
      <button onClick={createEmail}>emailアカウント作成する</button>
