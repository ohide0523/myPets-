...
const profile = () => {
  ...
  return (
    <div style={{ paddingTop:10,background:"#FFFFCC",textAlign:"center",width:"100%"}}>
      <h1><span><AssignmentIndIcon /></span>Myページ</h1>
      {myUser.length > 0 &&
 ...
 <TextField
      ...
      />
              ...
              <div style={{display:"flex",alignItems:"center",justifyContent:"center",background:"#66FF33"}}>
