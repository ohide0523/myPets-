...
<div className={classes.root}>
      ...
      <List component="nav" className={classes.listItem} aria-label="mailbox folders">
      <ListItem button>
        <ListItemText primary="MyDog" />
      </ListItem>
      <Divider />
      <ListItem button divider>
          <div style={{display:"flex",justifyContent:"space-arou"}}>
      ...
      <ListItem button>
        <ListItemText primary="FollowUser" />
      </ListItem>
      <Divider light />
    </List>
