      ...
      {anotherUser.length > 0 &&
        anotherUser.map((user, index) => (
          <div className={classes.root_profile} key={index}>
            ...
            />
            <div style={{display:"flex",alignItems:"center",justifyContent:"center",background:"skyblue",width:120,padding:5,borderRadius:20,color:"white"}}>
              <AccountBoxIcon />
              {user.followerCount}<div style={{fontSize:11}}>フォロワー</div>
            </div>
            <TextField
